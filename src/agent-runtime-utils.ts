...
export function buildAgentNotesRpcSubject(userId: string, agentId: string): string {
...
export function buildAgentThreadTagsRpcSubject(userId: string, agentId: string): string {
